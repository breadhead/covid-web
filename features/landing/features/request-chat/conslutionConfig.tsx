...
export const SUCCESS = () => (
  `<div>
    <p>
      Судя по всему, сейчас с вами всё в порядке. Но рекомендуем быть на чеку и
...
export const RISK_GROUP = () => (
  `<div>
    <p>
      Судя по всему, сейчас всё в порядке. Тем не менее, мы рекомендуем
...
export const ONCOLOGICAL = (
  `<div>
    <p>
      Если ваш вопрос связан с онкологическим заболеванием, мы рекомендуем вам
      ...
      теме. Если останутся вопросы - задайте их в чат. Наш обученный бот и врачи
...
export const WITH_OTHER_SYMPTOMS = (
  `  <div>
    <p>
      Судя по всему, сейчас всё в порядке - симптомы, описанные вами не
    ...
    <p>
      Если останутся вопросы - задайте их в чат.Наш обученный бот и врачи -
      волонтёры помогут разобраться.
    </p>
  </div>`
)
...
export const DANGER = (
  `  <div>
    <p>
      ВНИМАНИЕ! Симптомы, которые вы указали могут быть опасными, пожалуйста,
