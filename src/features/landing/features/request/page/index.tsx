        ...
        <section className="gl-wrapper gl-section">
          ...
          <Notification>
            <p className={styles.text}>
              ...
              медицинской услугой. Эксперты сервиса не ставят диагноз и не
              назначают лечение: это возможно только в медицинском учреждении на
              очной консультации врача.
            </p>
            <p className={styles.text}>
              Врачи-волонтеры «Просто спросить о COVID-201 предоставят вам
              актуальную информацию о заболевании, расскажут о методах
              профилактики, лечения и возможных осложнениях при COVID-19, а
              также подробно объяснят, что нужно делать в вашей ситуации.
            </p>
            <p className={styles.text}>
              Мы делаем все, чтобы вы получали ответы экспертов сервиса как
              можно скорее, но в связи с непростой эпидемиологической ситуацией
              ожидание может занять сутки. Пожалуйста, вызовите скорую, если ваш
              вопрос требует срочного ответа врача!
            </p>
            <p className={styles.text}>
