      ...
      <div className="gl-wrapper gl-section">
        ...
        <Notification>
          ...
          <p className={cx(styles.text)}>
            ...
            поста реанимации (6 коек). Представьте себе ситуацию, когда на 4-х
            из 6 коек стандартного поста у вас лежат пациенты с
            COVID-пневмонией, которые нуждаются в ИВЛ, а на двух койках —
            пациенты, которые нуждаются в оксигенации. Исходя из этой ситуации
            укажите ниже насколько хорошо обеспечен пост. Исходите из
            приблизительной оценки в количестве суток, на которые этот пост
