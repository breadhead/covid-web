  ...
  <div>
    ...
    <div className={cx('gl-text', s.description)}>
      ...
      <p className={s.bottomOffset}>
        ...
        едой, водой, психологическая помощь и многое другое. Мы быстро реагируем
        на нужды больниц, отвечаем на их просьбы о помощи, привлекаем
        финансирование, оперативно закупаем и доставляем все необходимое. 
      </p>
      <img
      ...
      <p>
        ...
        необходимо объединиться, чтобы помочь тем, кто помогает нам: докторам и
        медсестрам, которые приняли на себя главный удар.
      </p>
    </div>
  </div>
);
