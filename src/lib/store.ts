...
import {reducer as modalReducer, State as ModalState,} from '@app/src/features/common/modal';
import {reducer as loginReducer, State as LoginState,} from '@app/src/domain/reducers/loginReducer/reducer';
import {
...
import {requestFormReducer, RequestFormReducerState,} from '@app/src/domain/reducers/requestConsultationReducer';
import {reducer as browserQueryReducer, State as BrowserQueryState,} from '@app/src/features/common/browserQuery';
import {reducer as partnerReducer, State as PartnerState,} from '@app/src/domain/reducers/partnerReducer/reducer';
import {reducer as expertReducer, State as ExpertState,} from '@app/src/domain/reducers/expertReducer/reducer';
import {
