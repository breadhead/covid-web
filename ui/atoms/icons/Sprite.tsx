...
const Icon = () => (
  ...
  >
    ...
    <svg width="24" height="24" id="24x24_away-link" y="144">
    ...
    <svg width="24" height="24" id="24x24_cancel-red" y="216">
      <path
        d="M4.97 6.38a9 9 0 0 0 12.65 12.65L4.97 6.38zm1.41-1.41l12.65 12.65A9 9 0 0 0 6.38 4.97zM12 23a11 11 0 1 1 0-22 11 11 0 0 1 0 22z"
        fill="#EB4343"
        fill-rule="evenodd"
    ...
    <svg width="24" height="24" id="24x24_close_light" y="240">
      <path
    ...
    <svg width="24" height="24" id="24x24_consultation-new_blue" y="264">
      <path
    ...
    <svg width="24" height="24" id="24x24_download_light" y="288">
      <g fill="#B3B4C8">
    ...
    <svg width="24" height="24" id="24x24_edit" y="312">
      <path
    ...
    <svg width="24" height="24" id="24x24_input-valid_green" y="336">
      <path
    ...
    <svg width="24" height="24" id="24x24_loading_light" y="360">
      <g fill="none" fill-rule="evenodd">
        <path d="M0 0h24v24H0z" />
        <path
    ...
    <svg width="24" height="24" id="24x24_location_light" y="384">
      <g fill="#B3B4C8">
    ...
    <svg width="24" height="24" id="24x24_mail_light" y="408">
      <path
    ...
    <svg width="24" height="24" id="24x24_my-consultation" y="432">
      <path
    ...
    <svg width="24" height="24" id="24x24_new-message" y="456">
      <g fill="none" fill-rule="evenodd">
        <path
    ...
    <svg width="24" height="24" id="24x24_phone_light" y="480">
      <path
    ...
    <svg width="24" height="24" id="24x24_plus" y="504">
      <path
        d="M11 13H5a1 1 0 0 1 0-2h6V5a1 1 0 0 1 2 0v6h6a1 1 0 0 1 0 2h-6v6a1 1 0 0 1-2 0v-6z"
        fill="#616681"
      />
    </svg>
    <svg width="24" height="24" id="24x24_print_light" y="528">
      <path
    ...
    <svg width="24" height="24" id="24x24_search" y="552">
      <path
    ...
    <svg width="24" height="24" id="24x24_success_green" y="624">
      <path
    ...
    <svg width="24" height="24" id="24x24_user" y="648">
      <path
    ...
    <svg width="24" height="24" id="24x24_view" y="672">
      <path
    ...
    <svg width="32" height="32" id="32x32_chat" y="696">
      <g fill="none" fill-rule="evenodd">
        <path
    ...
    <svg width="32" height="32" id="32x32_chat_new-message" y="728">
      <g fill="none" fill-rule="evenodd">
        <path
