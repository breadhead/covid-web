...
const Sprite = () => (
  ...
  >
    <defs>
      ...
      <symbol width="24" height="24" id="24x24_away-link">
        <g fill="none" fillRule="evenodd">
      ...
      <symbol width="24" height="24" id="24x24_cancel-red">
        <path
          d="M4.97 6.38a9 9 0 0 0 12.65 12.65L4.97 6.38zm1.41-1.41l12.65 12.65A9 9 0 0 0 6.38 4.97zM12 23a11 11 0 1 1 0-22 11 11 0 0 1 0 22z"
          fill="#EB4343"
          fillRule="evenodd"
      ...
      <symbol width="24" height="24" id="24x24_close_light">
        <path
      ...
      <symbol width="24" height="24" id="24x24_consultation-new_blue">
        <path
      ...
      <symbol width="24" height="24" id="24x24_download_light">
      ...
      <symbol width="24" height="24" id="24x24_edit">
        <path
      ...
      <symbol width="24" height="24" id="input-valid">
      ...
      <symbol width="24" height="24" id="24x24_loading_light">
        <g fill="none" fillRule="evenodd">
          <path d="M0 0h24v24H0z" />
          <path
      ...
      <symbol width="24" height="24" id="24x24_location_light">
        <g fill="var(--color-default)">
      ...
      <symbol width="24" height="24" id="24x24_mail_light">
        <path
      ...
      <symbol width="24" height="24" id="24x24_my-consultation">
      ...
      <symbol width="24" height="24" id="24x24_new-message">
        <g fill="none" fillRule="evenodd">
          <path
      ...
      <symbol width="24" height="24" id="24x24_phone_light">
        <path
      ...
      <symbol width="24" height="24" id="24x24_plus">
        <path
          d="M11 13H5a1 1 0 0 1 0-2h6V5a1 1 0 0 1 2 0v6h6a1 1 0 0 1 0 2h-6v6a1 1 0 0 1-2 0v-6z"
          fill="var(--text-color-secondary)"
        />
      </symbol>
      <symbol width="24" height="24" id="24x24_print_light">
        <path
      ...
      <symbol width="24" height="24" id="24x24_search">
        <path
      ...
      <symbol width="24" height="24" id="24x24_success_green">
        <path
      ...
      <symbol width="24" height="24" id="24x24_user">
      ...
      <symbol width="24" height="24" id="24x24_view">
        <path
      ...
      <symbol width="32" height="32" id="32x32_chat">
        <g fill="none" fillRule="evenodd">
          <path
      ...
      <symbol width="32" height="32" id="32x32_chat_new-message">
        <g fill="none" fillRule="evenodd">
          <path
      ...
      <symbol width="24" height="24" id="icon-ArrowSmallRightGrey">
        <path
          d="M9.3 8.7a1 1 0 0 1 1.4-1.4l4 4a1 1 0 0 1 0 1.4l-4 4a1 1 0 0 1-1.4-1.4l3.29-3.3-3.3-3.3z"
          fill="var(--text-color-secondary)"
        />
